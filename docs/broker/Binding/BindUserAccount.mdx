...
Bind a user account to the broker relationship. The user needs to generate a signature using their own accessKey and secretKey, and the broker calls this interface with the user's signature to complete the binding.
