...
| LEVER_ORDER_082 | The position is currently closed and the operation is 不支持 for the time being |
| LEVER_ORDER_081 | Currently, manual processing is 不支持 |
| LEVER_ORDER_080 | The liquidation is currently in progress and the operation is 不支持 for the time being |
...
| LEVER_ORDER_005 | The current 最大 loanable amount in the market is insufficient |
