  ...
  function getTranslations() {
    return {
      en: {
        ...
        'item.label.Auto Earn': 'Auto Earn',
        'item.label.Auto Earn APIs': 'Auto Earn APIs',
        'item.label.Order Management': 'Order Management',
        'item.label.Order Management APIs': 'Order Management APIs',
        'item.label.Query': 'Query',
        'item.label.Query APIs': 'Query APIs',
        'item.label.Special Products': 'Special Products',
        'item.label.Special Products APIs': 'Special Products APIs',
      ...
      'zh-CN': {
        ...
        'item.label.Auto Earn': '自动理财',
        'item.label.Auto Earn APIs': '自动理财 API',
        'item.label.Order Management': '订单管理',
        'item.label.Order Management APIs': '订单管理 API',
        'item.label.Query': '查询',
        'item.label.Query APIs': '查询 API',
        'item.label.Special Products': '特殊产品',
        'item.label.Special Products APIs': '特殊产品 API',
