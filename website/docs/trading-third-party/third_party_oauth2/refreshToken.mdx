---
id: _third_party_oauth2_refreshtoken
title: Refresh Token
...
**GET** `/public/uaa/oauth2/token?client_id={client_id}&client_secret=${client_secret}&grant_type={grant_type}&refresh_token={refresh_token}`
...
| `grant_type` | string | 是 |  | authorization type, fixed value | refresh_token |
| `refresh_token` | string | 是 |  | The refresh_token field returned when applying for token |  |
