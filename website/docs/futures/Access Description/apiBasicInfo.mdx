...
- **How to obtain an APPKEY:** [Access Guide → Apply for API Key](../Access%20Description/SignatureGeneration)
- **How to generate a signature:** [Access Guide → Generate Signature](../Access%20Description/SignatureGeneration)
