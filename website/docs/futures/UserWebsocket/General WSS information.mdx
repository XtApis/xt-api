...
1. Call the API to obtain a **ListenKey**: [`GET https://fapi.xt.com/future/v1/user/listen-key`](https://fapi.xt.com/future/v1/user/listen-key). _(Tip: you may also link to “Contract API → User → Get ListenKey” in your docs sidebar.)_
2. After the WebSocket connection is established, to subscribe to **user‑related** events, send the JSON below:
...
- If you receive `invalid_listen_key`, the ListenKey has expired or is invalid. 👉 Request a new ListenKey via API.
